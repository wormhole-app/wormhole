...
fn wire_init_impl(port_: MessagePort, temp_file_path: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(init(api_temp_file_path))
        },
    )
}
...
fn wire_get_build_time_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, BuildInfo>(
        WrapInfo {
...
fn wire_default_rendezvous_url_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || move |task_callback| Ok(default_rendezvous_url()),
    )
}
fn wire_default_relay_url_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "default_relay_url",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(default_relay_url()),
    )
}
