...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_send_files(NativePortType port_,
      List<String> file_paths, String name, int code_length);

  external dynamic /* void */ wire_send_folder(
      NativePortType port_, String folder_path, String name, int code_length);
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_send_files(NativePortType port_, List<String> file_paths,
          String name, int code_length) =>
      wasmModule.wire_send_files(port_, file_paths, name, code_length);

  void wire_send_folder(NativePortType port_, String folder_path, String name,
          int code_length) =>
      wasmModule.wire_send_folder(port_, folder_path, name, code_length);
