...
class NativeImpl implements Native {
  ...
  Future<String> defaultRelayUrl({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_default_relay_url(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kDefaultRelayUrlConstMeta,
      argValues: [],
      hint: hint,
    ));
  }

  FlutterRustBridgeTaskConstMeta get kDefaultRelayUrlConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "default_relay_url",
        argNames: [],
      );
