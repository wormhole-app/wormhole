...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_server_config(
    ...
    wireObj.relay_url = api2wire_String(apiObj.relayUrl);
  }
}
...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  void wire_default_relay_url(
    int port_,
  ) {
    return _wire_default_relay_url(
      port_,
    );
  }

  late final _wire_default_relay_urlPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_default_relay_url');
  late final _wire_default_relay_url =
      _wire_default_relay_urlPtr.asFunction<void Function(int)>();
...
final class wire_ServerConfig extends ffi.Struct {
  ...
  external ffi.Pointer<wire_uint_8_list> relay_url;
}
